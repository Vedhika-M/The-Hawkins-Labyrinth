...
object LeaderboardManager {
    ...
    fun saveScore(
        ...
        val existing = prefs.getString(KEY_SCORES, "") ?: ""
        ...
        val saveString = top10.joinToString(";") {
            "${it.playerName},${it.score}"
        }
        prefs.edit().putString(KEY_SCORES, saveString).apply()
    }
    ...
    fun getScores(
        ...
        val saved = prefs.getString(KEY_SCORES, "") ?: ""
